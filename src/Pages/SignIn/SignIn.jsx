            ...
            <div className="hero-content flex-col lg:flex-row w-full max-w-xl lg:max-w-2xl">
                ...
                <div className="card bg-white w-full shadow-2xl p-8 rounded-lg">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            <span className="label-text-alt text-black">Already have an account?</span>
                            <Link to={'/login'} className="label-text-alt link link-hover text-blue-700"> Login</Link>
                        </div>
                    </form>
                    ...
                    <button onClick={handleGoogleLogin} className="btn bg-red-500 text-white hover:bg-red-600 transition">
                        Sign in with Google
                    </button>
                </div>
            </div>
